...
Tämä käyttäytyminen helpottaa välttämään hienovaraisia bugeja. Tässä on pieni chat-sovellus. Yritä arvata mitä tapahtuu kun painat ensin "Lähetä" ja *sitten* muutat vastaanottajan Jaakoksi. Kenen nimi tulee näkymään `alert`:ssa viiden sekuntin jälkeen?
